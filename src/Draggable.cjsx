...
module.exports = class Draggable extends React.Component
    ...
    Object.defineProperties @prototype,
        ...
        isDragging:
            get: -> @_isDragging or false
        isAnimating:
            get: -> @_isAnimating or false
        isMoving:
            get: -> @_isMoving or false

        layerStartPoint:
            get: -> @_layerStartPoint or @layer.point
        cursorStartPoint:
            get: -> @_cursorStartPoint or {x:0, y:0}
        layerCursorOffset:
            get: -> @_layerCursorOffset or {x:0, y:0}
